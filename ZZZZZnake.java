public class ZZZZZnake {
  ...
  public static void main( String[] args ) {
    ...
    while ( true ) { // 2)
      ...
      /* switch ist eine Abkürzung für eine "if/else if/else if..."-Situation mit mehreren Verzweigungen.
       * break; steht, damit die danach stehenden cases nicht mehr geprüft werden.
       */
